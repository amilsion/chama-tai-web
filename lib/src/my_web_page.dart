import '../../src/content/contact_content.dart';
import '../../src/content/feature_content.dart';
import '../../src/content/home_content.dart';
import '../../src/content/screenshots_content.dart';
import '../../src/navigation_bar/nav_bar.dart';
...
class MyWebPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    double maxWith = width > 1920 ? 1920 : width;
